...
if __name__=="__main__":
    ...
    taglist = ['O', 'B-Autor', 'I-Autor', 'B-Aktenzeichen', 'I-Aktenzeichen', 'B-Auflage', 'I-Auflage', 'B-Datum',
               'I-Datum', 'B-Editor', 'B-Gesetz', 'I-Gesetz', 'B-Gericht', 'I-Gericht', 'B-Jahr', 'B-Nummer', 'I-Nummer',
               'B-Randnummer', 'I-Randnummer', 'B-Paragraph', 'I-Paragraph', 'B-Seite-Beginn', 'I-Seite-Beginn',
               'B-Seite-Fundstelle', 'B-Titel', 'I-Titel', 'B-Zeitschrift', 'I-Zeitschrift', 'I-Editor',
               'I-Seite-Fundstelle', 'B-Wort:Auflage', 'I-Wort:Auflage', 'B-Wort:aaO', 'I-Wort:aaO']
    ...
    print(f"length of extra dataset: {len(extra_dataset)}")
    ...
    # trainer.save_model("model/bert_multiclass_original")
    ...
    print("EVAL Results On Test Set ===========================================")
    ...
    # predictions, labels, _ = trainer.predict(tokenized_extra_dataset)
    ...
    # Also print the classification report in string format
    ...
    # print("Metrics for the standard NER report:")
    # for metric in metrics:
    #     value = report[target][metric]
    #     print(f"{metric.title()}: {value:.4f}")


    # === Custom Average Without 'O' ===
    metrics = ["precision", "recall", "f1-score"]
    ...
    print("Average metrics excluding label 'O':")
    for metric in metrics:
        avg_value = metric_sums[metric] / count if count > 0 else 0.0
        print(f"{metric.title()}: {avg_value:.4f}")
